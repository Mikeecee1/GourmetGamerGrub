...
const menuArray = [
 new FoodItem('Call of Du(r)ty Burger',  8.00, 'Succulent double quarter pounder in a brioche bun with special gamer relish', imgArray[0],1),
 ...
 new FoodItem ('Super Mmm.. kart', 20.00, 'A box of top treats to keep you on track', imgArray[2],  3),
 ...
 new FoodItem ('Hangry Birds', 6.75, 'keep chill with these spicy chicken wings', imgArray[0], 2 ),
 new FoodItem ('Freddie Fries', 6.75, 'Loaded Fries', imgArray[0], 2 ),
 new FoodItem ('Freddie Fries', 6.75, 'Loaded Fries', imgArray[0], 2 ),
 new FoodItem ('Call Of Fruity', 3.00, 'Fruity Smoothie',imgArray[3], 4)
];
